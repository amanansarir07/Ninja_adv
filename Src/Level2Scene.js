...
export class Level2Scene extends BaseLevelScene {
  ...
  createEnemies() {
    this.registerEnemy(new SwiftNinja(this, 12 * 64, 16 * 64))
    this.registerEnemy(new SoundNinja(this, 20 * 64, 14 * 64))
    this.registerEnemy(new SwiftNinja(this, 23 * 64, 14 * 64))
    this.registerEnemy(new SoundNinja(this, 30 * 64, 15 * 64))
    this.registerEnemy(new EliteNinja(this, 17 * 64, 11 * 64))
  }
